...
<html lang="en">
  ...
  <body>
    ...
    <div id="container">
		<div id="start">
			...
			<!---fb-->
				...
				<p id="step1">What are the most often used words in your FACEBOOK posts?</p>
    ...
    <footer class="footer">
      <div class="container">
        <span class="text-muted">Follow Us</span><br>
		<a class="fa fa-facebook-official" style="font-size:40px;color:#aaa;" href="https://www.facebook.com/findtamsui/"></a>
      </div>
    </footer>
